...
class DataEncoder:
    ...
    def decode(self, loc_pred, cls_pred, cls_threshold=0.7, nms_threshold=0.3):
        """
        It chooses an anchor box with the highest confidence
        removes any overlapping anchor boxes with an IoU greater than 0.5.
        """
...
def decode_boxes(deltas, anchors):
    """
    compute anchors width, height, centers
    deltas: 
    """
